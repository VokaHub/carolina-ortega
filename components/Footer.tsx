      ...
      <div className="max-w-7xl mx-auto px-6">
        <div className="grid md:grid-cols-3 gap-16 mb-16">
          <div className="flex flex-col gap-4">
            ...
            />
            <span className="text-[11px] uppercase tracking-[0.3em] text-[#B2977B] font-bold block">Psicóloga Clínica</span>
          </div>
          ...
          <div>
            <h4 className="text-white font-bold mb-6 uppercase text-[11px] tracking-widest border-b border-white/10 pb-2 inline-block">Confidencialidad</h4>
            ...
            <span className="text-[11px] uppercase tracking-widest text-[#B2977B] font-bold">Privacidad garantizada</span>
          </div>
        </div>

        <div className="border-t border-white/5 pt-10 flex flex-col md:flex-row justify-between items-center gap-6 text-[10px] uppercase tracking-[0.2em] font-bold opacity-40">
