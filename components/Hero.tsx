        ...
        <div className="max-w-3xl">
          <div className="inline-flex items-center gap-4 px-4 py-2 bg-white border border-[#DDE6ED] rounded-full mb-8 shadow-sm">
            <div className="flex items-center gap-2">
              ...
              <span className="text-[10px] uppercase tracking-[0.15em] font-bold text-[#353C51]/60 text-nowrap">Presencial</span>
            </div>
            ...
            <div className="flex items-center gap-2">
              ...
              <span className="text-[10px] uppercase tracking-[0.15em] font-bold text-[#353C51]/60 text-nowrap">En línea</span>
            </div>
          </div>
